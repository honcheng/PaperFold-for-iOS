...
@interface VerticalFoldView : UIView
// each folderView consists of 2 facing views: topView and bottomView
@property (strong, nonatomic) FacingView *topView, *bottomView;
